...
half3 CalculateCellShading(BRDFData brdfData, BRDFData brdfDataClearCoat,
...
half4 PBRCellShading(InputData inputData, SurfaceData surfaceData)
{
    ...
    {
        lightingData.mainLightColor = CalculateCellShading(brdfData, brdfDataClearCoat, mainLight.color, mainLight.direction,
    ...
    for (uint lightIndex = 0; lightIndex < min(_AdditionalLightsDirectionalCount, MAX_VISIBLE_LIGHTS); lightIndex++)
    {
        ...
        {
        	lightingData.additionalLightsColor += CalculateCellShading(brdfData, brdfDataClearCoat, light.color, light.direction,
